...
final class TypeLoader implements TypeLoaderInterface
{
    private const OPTIONS = [
        ...
        Custom67x101::TYPE => Custom67x101::class,
        Custom68x96::TYPE => Custom68x96::class,
        Custom72x96::TYPE => Custom72x96::class,
        Custom72x120::TYPE => Custom72x120::class,
        Custom80x101::TYPE => Custom80x101::class,
        Custom90x90::TYPE => Custom90x90::class,
        Custom92x96::TYPE => Custom92x96::class,
        Custom92x128::TYPE => Custom92x128::class,
        ...
        Custom104x128::TYPE => Custom104x128::class,
        Custom104x208::TYPE => Custom104x208::class,
        Custom109x128::TYPE => Custom109x128::class,
        Custom112x112::TYPE => Custom112x112::class,
        ...
        Custom162x172::TYPE => Custom162x172::class,
        ...
        Custom256x320::TYPE => Custom256x320::class,
        ...
        Custom320x640::TYPE => Custom320x640::class,
        ...
        Custom720x1498::TYPE => Custom720x1498::class,
        ...
        Custom720x1600::TYPE => Custom720x1600::class,
        Custom720x1640::TYPE => Custom720x1640::class,
        ...
        Custom1080x2032::TYPE => Custom1080x2032::class,
        ...
        Custom1080x2460::TYPE => Custom1080x2460::class,
        ...
        Custom1080x3040::TYPE => Custom1080x3040::class,
        ...
        Custom1176x2400::TYPE => Custom1176x2400::class,
        Custom1242x2688::TYPE => Custom1242x2688::class,
        Custom1200x2000::TYPE => Custom1200x2000::class,
        Custom1200x2640::TYPE => Custom1200x2640::class,
        Custom1280x1920::TYPE => Custom1280x1920::class,
        Custom1312x2560::TYPE => Custom1312x2560::class,
        Custom1344x2772::TYPE => Custom1344x2772::class,
        ...
        Custom1440x2992::TYPE => Custom1440x2992::class,
        Custom1440x3040::TYPE => Custom1440x3040::class,
        Custom1440x3088::TYPE => Custom1440x3088::class,
        Custom1440x3120::TYPE => Custom1440x3120::class,
        Custom1440x3168::TYPE => Custom1440x3168::class,
        ...
        Custom1752x2800::TYPE => Custom1752x2800::class,
        Custom1768x2208::TYPE => Custom1768x2208::class,
